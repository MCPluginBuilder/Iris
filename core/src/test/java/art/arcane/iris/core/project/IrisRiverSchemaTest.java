...
public class IrisRiverSchemaTest {
    ...
    public void hydrologySchemaExposesTypedPhysicalHierarchy() {
        ...
        assertEquals(0, channel.getJSONObject("inset").getInt("minimum"));
        assertEquals(3, channel.getJSONObject("inset").getInt("maximum"));
        ...
        assertEquals(0, banks.getJSONObject("freeboard").getInt("minimum"));
        assertEquals(4, banks.getJSONObject("freeboard").getInt("maximum"));
